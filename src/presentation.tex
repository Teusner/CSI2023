                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}
                        \begin{axis}[
                            ...
                            \addplot[RoyalBlue] table [x expr={\fpeval{\thisrow{stamp} - 1686731143.}}, y=depth, col sep=comma] {data/simulation/simulation_pressure.csv};
                        \end{axis}
                        ...
                        \begin{axis}[
                            ...
                            \addplot[Dandelion] table [x expr={\fpeval{\thisrow{stamp} - 1686731143.}}, y=p_fin, col sep=comma] {data/simulation/simulation_actuators.csv};
                            \addplot[RubineRed] table [x expr={\fpeval{\thisrow{stamp} - 1686731143.}}, y=s_fin, col sep=comma] {data/simulation/simulation_actuators.csv};
                        \end{axis}
                        ...
                        \begin{axis}[
                            ...
                            \addplot[RoyalPurple] table [x expr={\fpeval{\thisrow{stamp} - 1686731143.}}, y=pressure, col sep=comma] {data/simulation/simulation_pressure.csv};
                        \end{axis}
                        ...
                        \begin{axis}[
                            ...
                            \addplot[ForestGreen] table [x expr={\fpeval{\thisrow{stamp} - 1686731143.}}, y=pitch_deg, col sep=comma] {data/simulation/simulation_imu.csv};
                        \end{axis}
                    \end{tikzpicture}
                    \caption{Mission simulation}
                \end{figure}
